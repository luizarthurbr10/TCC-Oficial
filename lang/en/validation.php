...
return [
    ...
    | pela classe de validador. Algumas dessas regras têm versões múltiplas, como
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar nossos atributos por
    | algo mais amigável para o usuário, como 'E-mail' em vez de 'email'. Isso
    | simplesmente nos ajuda a tornar nossas mensagens mais limpas.
    |
    */
